        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AnswerText = table.Column<string>(type: "nvarchar(max)", maxLength: 10000, nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    ...
                    MarkedByTeacherId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Submissions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Submissions_AspNetUsers_MarkedByTeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentEnrollments_AcademicClassId",
                table: "StudentEnrollments",
                column: "AcademicClassId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentEnrollments_StudentId_AcademicClassId",
                table: "StudentEnrollments",
                columns: new[] { "StudentId", "AcademicClassId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_MarkedByTeacherId",
                table: "Submissions",
